...
public class ListaEnlazada{
    ...
    public void agregarElemento(String nombre, String correo, String FechaN, String edad, String carrera, String telefono){
    Nodo n = new Nodo( nombre, correo, FechaN, edad, carrera, telefono);
    ...
    public Nodo obtenerElemento(String n){
        ...
        public boolean encontrarPorNombre(String n){
        Elemento actual = this.primerElemento;
        while(actual != null){
            if(actual.obtenerElemento().getNombre() == n){
                return true;
